...
public class BookServiceImpl implements BookService {
	...
	@Transactional
	@Override
	public Collection<BookDto> findBooksByAuthor(String authorName) {
	...
	@Transactional
	@Override
	public Collection<BookDto> findBooksByPublisher(String publisherName) {
	...
	@Transactional
	@Override
	public Collection<AuthorDto> findBookAuthors(String isbn) {
		Book book = bookRepository.findById(isbn).orElseThrow(EntityNotFoundException::new);
